package com.research.cacheasidemediumcomplexity.Config;
...
@Component
public class JsonObjectTransactionEntitySerializer implements RedisSerializer<JsonObjectTransactionEntity> {
